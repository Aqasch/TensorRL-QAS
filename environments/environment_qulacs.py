...
# from quri_parts.qulacs.circuit import convert_circuit as quri_to_qulacs
# from 
                ...
                for c in circ:
                    ...
                    if c.op.name != 'cx':
                        ...
                        if len(str(c.qargs)) <=38:
                            ...
                            # print(len(str(c.qargs)))
                            # print(c.qargs, str(c.qargs)[indx+6], str(c.qargs)[indx+7])
                        ...
                        # 
                            ...
                            if len(str(c.qargs[0])) <= 34:
                                ...
                                # print(c.qargs[0]._index, c.qargs[1]._index)
